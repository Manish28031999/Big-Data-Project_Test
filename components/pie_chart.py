...
Season_select = html.Div(className="col-lg-4 col-md-3 col-sm-3 card-chart-container", children=[html.Div(className="card-chart", children=[
...
IPLpiechart = html.Div(className="card-chart-container col-lg-4 md-1 sm-1",
                    children=[
                        html.Div(
